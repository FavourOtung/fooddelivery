...
const RightmenuMobile = ({closeRightMenu}) => {
  return (
    <div className='bg-white w-80 p-5 absolute right-0'  >
      <nav className='flex justify-between items-center py-2'>
        ...
        <div className='flex items-center gap-3 text-[25px] text-bold cursor-pointer'>
        <div className='px-1 pt-1 rounded-lg bg-gray-200'>
          <img className='w-7' src='/images/profile.png'/>
        </div>
        <p onClick={()=>closeRightMenu(false)}>×</p>
        </div>
